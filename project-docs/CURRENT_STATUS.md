...
- Service-page mobile fixed headers are anchored to the viewport via shared `assets/nav.css`, preventing the padded mobile wrapper from pushing the header/menu row to the right.
