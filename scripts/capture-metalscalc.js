...
(async () => {
  ...
  // --- app.spotcalc.com screenshots ---
  const appCtx = await browser.newContext({ viewport: { width: 1440, height: 900 } });
  const appPage = await appCtx.newPage();
  await appPage.goto('https://app.spotcalc.com', { waitUntil: 'networkidle', timeout: 30000 });
  ...
  await siteMobPage.goto('https://spotcalc.com', { waitUntil: 'networkidle', timeout: 30000 });
